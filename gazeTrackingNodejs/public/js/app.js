...
// Fullscreen EEG functionality
let isFullscreen = false;
const eegContainer = document.querySelector('.SecondCol');
...
function toggleFullscreen() {
    ...
    if (isFullscreen) {
        eegContainer.classList.add('fullscreen-eeg');
        fullscreenToggle.querySelector('i').classList.remove('glyphicon-fullscreen');
        fullscreenToggle.querySelector('i').classList.add('glyphicon-resize-small');
    } else {
        eegContainer.classList.remove('fullscreen-eeg');
        fullscreenToggle.querySelector('i').classList.remove('glyphicon-resize-small');
        fullscreenToggle.querySelector('i').classList.add('glyphicon-fullscreen');
    }
    
    // Trigger a resize event to redraw the EEG plots
